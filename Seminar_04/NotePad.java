...
public class NotePad implements Iterable<Task>, Serializable {
    ...
    public void addTaskFromUserByCheck(int chek){
        ...
        System.out.println("Введите дату (Пример: 2023 07 22)");
       ...
       // input.nextLine();т
        ...
        System.out.println("Установите время дедлайна (Пример: 16:50)");
        String deadLineTime = input.next();
        System.out.println("Установите дату дедлайна(Пример: 2023,07,22)");
